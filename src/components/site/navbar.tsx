    ...
    <div className={cn(
      ...
      <header
        className={cn(
          ...
          !isScrolled
            ? "max-w-7xl mx-auto rounded-2xl sm:rounded-[2rem] bg-white/40 dark:bg-black/10 backdrop-blur-lg dark:backdrop-blur-sm py-3 sm:py-5 border border-white/40 dark:border-white/5 shadow-xl"
            : "max-w-none rounded-none bg-white/90 dark:bg-slate-900/80 backdrop-blur-xl dark:backdrop-blur-md py-3 border-b border-slate-200/50 dark:border-white/10 shadow-2xl"
        )}
      >
        <div className="max-w-7xl mx-auto w-full px-4 sm:px-6 flex items-center justify-between gap-2">
          ...
          >
            ...
            <div className="relative z-10 [&>svg]:w-full [&>svg]:h-auto pl-1 sm:pl-2 transform sm:scale-125 origin-left">
              <Logo />
            </div>
          </Link>
          ...
          <div className="hidden lg:flex items-center gap-4 shrink-0">
            ...
            <DropdownMenu>
              ...
              <DropdownMenuContent align="end" className="w-56 bg-white/95 dark:bg-slate-900/95 backdrop-blur-2xl border border-white/40 dark:border-white/10 shadow-2xl rounded-2xl p-2 mt-2">
          ...
          <div className="lg:hidden flex items-center gap-2 shrink-0">
            ...
            <Sheet>
              ...
              <SheetContent side="right" className="w-[85vw] sm:max-w-md bg-white/95 dark:bg-slate-950/95 border-l border-white/20 dark:border-white/10 backdrop-blur-3xl p-6 flex flex-col overflow-y-auto">
                <SheetHeader className="text-left mb-8 mt-4">
                  <SheetTitle className="font-black text-slate-900 dark:text-white text-2xl sm:text-3xl uppercase tracking-tighter">
                    Menú
                  </SheetTitle>
                  <SheetDescription className='text-slate-600 dark:text-slate-400 font-medium'>Navegación principal del sitio.</SheetDescription>
                </SheetHeader>
