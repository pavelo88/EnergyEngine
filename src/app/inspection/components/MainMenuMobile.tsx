...
const quickInspections = [
  { id: 'hoja-trabajo', label: 'Hoja Trabajo', icon: <FileText size={28} />, color: 'from-emerald-600 to-emerald-400' },
  { id: 'informe-tecnico', label: 'Inf. Técnico', icon: <Settings size={28} />, color: 'from-emerald-700 to-emerald-500' },
  { id: 'informe-revision', label: 'Inf. Revisión', icon: <ClipboardCheck size={28} />, color: 'from-teal-600 to-teal-400' },
    ...
    <div className="w-full font-sans space-y-8 pb-32">
      <header className="px-2 pt-4">
        <div className="flex items-center gap-4">
          <div className="w-14 h-14 rounded-2xl bg-gradient-to-br from-[#062113] to-emerald-800 flex items-center justify-center text-[#10b981] shadow-xl shadow-[#10b981]/20 transform -rotate-3">
            <User size={28} />
          </div>
          <div>
      ...
      <section className="space-y-4 pt-2">
        ...
        <div className="flex flex-col gap-3">
          {navigationItems.map((item) => (
            ...
            >
              <div className={`w-10 h-10 rounded-xl ${item.color} text-white flex items-center justify-center shadow-lg shadow-emerald-500/10`}>
                {item.icon}
              </div>
