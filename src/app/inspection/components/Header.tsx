...
export default function Header({ activeTab, isOnline, onBack, isSubNavActive, onInstall, canInstall }: HeaderProps) {
  ...
  return (
    <header className="fixed top-0 left-0 w-full px-6 py-4 bg-slate-800 backdrop-blur-lg border-b border-white/10 flex justify-between items-center z-50 shadow-lg h-16">
